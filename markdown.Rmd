...
impute.test <- test
impute.test$Age <- impute(test$Age, mean)
...
test$Age[is.na(test$Age) & test.mr.log] <- mr.age
test$Age[is.na(test$Age) & test.mrs.log] <- mrs.age
test$Age[is.na(test$Age) & test.master.log] <- master.age
test$Age[is.na(test$Age) & test.miss.log] <- miss.age
