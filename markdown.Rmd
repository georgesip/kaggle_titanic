...
>>>>>>> c160f4ab36d9728ea8038bed041ef91c00cb5ccc
```{r, warning=FALSE}
#testing QDA
...
test.knn = train.knn = cbind(Sex,Age,Pclass,SibSp,Parch,Fare)[-train.vector, ]
set.seed(1)
# KNN(1)
knn.pred = knn(train.knn, test.knn, train.set, k = 3, na.action=na.omit)
