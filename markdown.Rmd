...
set.seed(1)
train.set = train[1:490,]
test.set = test[491:891,]
```
...
```{r}
#Try LDA
lda.fit=lda(Survived~Sex + Age + Pclass + SibSp + Parch + Fare,data=train.set)
lda.pred=predict(lda.fit, test.set)
lda.class=lda.pred$class
table(lda.class ,train.set$Survived)
mean(lda.class==test.set$Survived)
